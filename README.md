...
**Feel free to explore, fork, and learn from this project.** If you're on a similar learning journey, I hope the comments and structure help you understand not just *what* the code does, but *why* it's written that way. Build along with me, break things, fix them — that's the process.
...
*🍛 Samrub — Because every meal tells a story.*
